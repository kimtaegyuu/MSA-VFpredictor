...
#-------------------------------------------------------------
#  make msa data (.a3m) to msa-composition data (.npy)
#-------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    parser.add_argument('--msa', type=str, help="input '.a3m' file", required=True)
    parser.add_argument('--msa_composition', type=str, help="output '.npy' file", required=True)
    ...
    inputs = greedy_select(read_msa(args.msa),128)
    ...
    np.save(args.msa_composition,msa_composition_data)
