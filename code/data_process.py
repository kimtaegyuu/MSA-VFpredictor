...
if __name__ == '__main__':
    ...
    parser.add_argument('--a3m_data', type=str, default="data/example/1.a3m")
    parser.add_argument('--msa_composition_data', type=str, default="data/example/positive_train_msa_composition1")
    ...
    np.save(args.msa_composition_data+'.npy',msa_composition_data)
